...
<div class="container">
    <div class="row text-center">
        <div class="col-md-11 col-sm-6 text-left p-2"> 
            <h5> <i class="fa fa-search ml-4 pl-2">User Account</i></h5>
        </div>  
        <div class="col-md-1 col-sm-6 text-right p-2">
            @can('user-create')
            <a href="{{ route('create_users') }}" class="btn btn-info btn-sm" name="create_recode" id="create_recode" ><i class="fa fa-plus"></i>&nbsp; New</a>
            @endcan
        </div>
    </div>
    ...
    @can('role-list')
        @foreach ($userdata as $key => $user)
            <tr>
                ...
                <td>
                <a class="btn btn-outline-info btn-sm" href="{{ route('show_users',$user->id) }}">Show</a>
                <a class="btn btn-outline-primary btn-sm" href="{{ route('edit_users',$user->id) }}">Edit</a>
                @can('user-delete')
